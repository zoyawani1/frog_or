...
MASTER_LIST="${MASTER_LIST:-${STEP2_BASE}/chunk_files_master.list}"
SCRIPT_PATH="/project/stuckert/users/wani/f2/scripts/18_prune_chunk_with_granges.R"
